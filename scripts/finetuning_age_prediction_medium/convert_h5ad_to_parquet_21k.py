#!/usr/bin/env python3
"""
Convert 21k AltumAge h5ad dataset to MethylGPT parquet format.

Aligns 21k CpG sites to the 49,156 MethylGPT reference.
CpGs not present in the 21k panel are filled with NaN (→ pad token at runtime).
Splits are taken from adata.obs["split"] (train / valid / test).

Usage (on cluster):
    python convert_h5ad_to_parquet_21k.py
"""
